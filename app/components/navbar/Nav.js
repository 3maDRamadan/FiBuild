  ...
  return (
    <header className="container">
      <nav className="navbar">
        <img src="../../imgs/icon.png" alt=" ترميم منازل تشطيب شقق توسعات سيراميك مقاول ترميم مباني تركيب سراميك جيتاروف ديكور الكويت مقاول بناء مقاولات عامة بناء هيكل اسود اصباغ اعمال صحي بناء ملاحق ومصاعد ترميمات عامة هدم بناء مساح سيجما توسيعات اضافة ادوار تكسير حمامات ومطابخ" />
        <ul>
          {links.map((link) => (
